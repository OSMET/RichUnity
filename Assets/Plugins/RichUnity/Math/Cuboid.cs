...
namespace Assets.Plugins.RichUnity.Math {
    ...
    public class Cuboid {
        public float Left {
            get { return Center.x - Width / 2f; }
        }

        public float Bottom {
            get { return Center.y - Height / 2f; }
        }

        public float Back {
            get { return Center.z - Depth / 2f; }
        }
        ...
        public Vector3 LeftBottomBackVertex {
            get { return new Vector3(Left, Bottom, Back); }
        }

        public Vector3 LeftBottomFrontVertex {
            get { return new Vector3(Left, Bottom, Front); }
        }

        public Vector3 LeftTopBackVertex {
            get { return new Vector3(Left, Top, Back); }
        }

        public Vector3 LeftTopFrontVertex {
            get { return new Vector3(Left, Top, Front); }
        }

        public Vector3 RightBottomBackVertex {
            get { return new Vector3(Right, Bottom, Back); }
        }

        public Vector3 RightBottomFrontVertex {
            get { return new Vector3(Right, Bottom, Front); }
        }

        public Vector3 RightTopBackVertex {
            get { return new Vector3(Right, Top, Back); }
        }

        public Vector3 RightTopFrontVertex {
            get { return new Vector3(Right, Top, Front); }
        }
